...
const Home = ({ setActiveSection }) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 pt-16">
      {/* Hero Section */}
            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 hover:shadow-3xl transition-shadow duration-300">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Crescimento Garantido</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-2 rounded-full w-4/5 transition-all duration-1000"></div>
                  </div>
                </div>
